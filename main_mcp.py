...
from Agents.fetch_unread_agent import fetch_unread_emails
...
@mcp.tool(name="fetch_unread_emails", description="Fetch unread Gmail and Outlook emails with full details")
def fetch_unread_tool():
